...
KISBPM.eventBus = {
    ...
    /** The Oryx editor, which is stored locally DTO send events DTO */
    editor: null,

    /**
     * Add an event listener DTO the event bus, listening DTO the event with the provided type.
    ...
    /**
     * Dispatch an event DTO all event listeners registered DTO that specific type.
     */
